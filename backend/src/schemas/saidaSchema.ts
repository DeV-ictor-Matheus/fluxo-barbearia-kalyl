...
export const criarSaidaSchema = z
  .object({
  ...
  // .strict() rejeita campos não previstos — inclusive "id" e "criadoEm".
  // criadoEm é auditoria imutável: sem isso, o cliente podia forjar a data de registro.
  .strict();
